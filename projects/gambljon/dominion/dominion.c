...
/* function 1 taken out of switch */
int run_adventurer(int drawntreasure, struct gameState *state, int currentPlayer, int z, int *temphand)
{
  int cardDrawn;
...
/* function 2 taken out of switch */
...
/* function 3 taken out of switch */
int run_gardens()
{
  return -1;
}
/* function 4 taken out of switch */
...
/* function 5 taken out of switch */
int run_great_hall(int currentPlayer, struct gameState *state, int handPos)
{
  //+1 Card
  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  case adventurer:
    run_adventurer(drawntreasure, state, currentPlayer, z, temphand);
    return 0;
  ...
  case village:
    run_village(currentPlayer, state, handPos);
    return 0;
  ...
  case great_hall:
    run_great_hall(currentPlayer, state, handPos);
    return 0;
