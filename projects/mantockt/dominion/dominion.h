...
int adventurer_effect(int, struct gameState *);
/* Responsible for playing out the actions and effects of using the Adventurer Card */
int great_hall_effect(int, int, struct gameState *);
/* Responsible for playing out the actions and effects of using the Great Hall Card */
int sea_hag_effect(int, struct gameState *);
/* Responsible for playing out the actions and effects of using the Sea Hag Card */
int smithy_effect(int, int, struct gameState *);
/* Responsible for playing out the actions and effects of using the Smithy Card */
int steward_effect(int, int, int, int, int, struct gameState *);
/* Responsible for playing out the actions and effects of using the Steward Card */
